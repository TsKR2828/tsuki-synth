...
private:
    ...
    static const std::vector<PresetNameEntry>& presetNameTable()
    {
        static const std::vector<PresetNameEntry> t = {
            ...
            { "Brass Gamelan",           "黃銅甘美朗"     },
            { "Rubber Muted Pluck",      "橡膠悶撥"       },
            { "Crystal Tongue Drum",     "水晶空靈鼓"     },
            { "Bronze Water Gong",       "青銅水鑼"       },
            { "Wooden Kalimba",          "木製拇指琴"     },
            { "Ethereal Steel Bells",    "空靈鋼鐘"       },
            { "Glass Singing Bowl",      "玻璃頌缽"       },
            { "Rubber Tongue Pad",       "橡膠舌鼓鋪底"   },
            { "Acoustic Piano",          "原聲鋼琴"       },
            { "Electric Rhodes",         "電鋼琴"         },
            { "Layered E.Piano",         "層疊電鋼琴"     },
            { "FM Vibraphone",           "FM 顫音琴"      },
            { "DX7 Crystal Bell",        "DX7 水晶鐘"     },
            { "Church Organ",            "教堂風琴"       },
            { "Ambient Pad",             "氛圍鋪底"       },
            { "FM Bass",                 "FM 貝斯"        },
            { "FM Brass",                "FM 銅管"        },
            { "Steel Hammered Dulcimer (Body)", "鋼製揚琴（共鳴體）" },
            { "Copper Warm Strings (Body)",     "銅弦暖音（共鳴體）" },
            { "Crystal Tongue Drum (Body)",     "水晶空靈鼓（共鳴體）" },
            { "Bronze Water Gong (Body)",       "青銅水鑼（共鳴體）" },
        };
        return t;
    }
};
