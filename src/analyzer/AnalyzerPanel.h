...
public:
    ...
    void paint (juce::Graphics& g) override
    {
        ...
        g.setFont (TsukiLookAndFeel::scaledFont (9.0f).boldened());
        g.drawText (UiLocale::label ("ui_scope"), (int) b.getX() + 8, (int) b.getY() + 4,
    ...
    void resized() override
    {
        ...
        auto inner = getLocalBounds().reduced (6, 0).withTrimmedTop (26);
