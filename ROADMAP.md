...
**當前目標：Phase 5 — FM Piano 引擎**

1. 建立 `FMPianoEngine.h` — carrier + modulator + index envelope
2. 從原型 synth.html 移植 FM 合成邏輯
3. PluginProcessor 加入第三引擎切換
4. Velocity 感應 + 高頻 brightness 衰減
5. PluginEditor 加入 FM Piano 參數面板

**已達成里程碑：**
- ✅ 里程碑 1：在 DAW 裡載入空殼插件聽到正弦波（2026-05-08）
- ✅ 里程碑 2：正弦波替換為物理建模弦 → 聽到真實的揚琴泛音結構（2026-05-08）
- ✅ 里程碑 3：Chromatic 三合一引擎完成 — 梁/板/自訂泛音（2026-05-08）
- ⬜ 里程碑 4：FM Piano 引擎 → 完成三引擎合一插件
